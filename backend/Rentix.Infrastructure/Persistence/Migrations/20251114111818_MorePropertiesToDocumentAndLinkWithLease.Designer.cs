...
namespace Rentix.Infrastructure.Migrations
{
    ...
    [Migration("20251114111818_MorePropertiesToDocumentAndLinkWithLease")]
    partial class MorePropertiesToDocumentAndLinkWithLease
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rentix.Domain.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Rentix.Domain.Entities.Payment", b =>
                {
                    b.HasOne("Rentix.Domain.Entities.Lease", "Lease")
                        .WithMany("Payments")
